...
<html lang="en">
	...
	<meta name="description" content="actualités sur le  rechauffement climatique">
	...
	<body
		...
		<div class="background-wallpaper-container">
			<img src="/build/images/template-imgs/recyclage-rechauffement-climatique.png" alt="" class="background-wallpaper" style='height:100%;'/>
	...
	.image-gallery div:nth-child(1){
		background-image: url("/build/images/resized-imgs/catastrophes-rechauffement-climatique.png");
	...
	<div
		...
		<div class="post-info">
			<span>Article du
				Apr 20, 2002, 1:11:11 PM
				écrit par
				Isaac Goncalves</span>
		</div>
		<!-- Post Detail End -->
...
Il s’agit d’un phénomène naturel extrême, amplifié par les conditions météorologiques, ainsi que par d’autres causes que nous allons examiner.
		...
		<div class="post-image margin-top-40 margin-bottom-40">
			...
			<img src="/build/images/pattern-bg.3c10a35f.png" alt="premiere image">
