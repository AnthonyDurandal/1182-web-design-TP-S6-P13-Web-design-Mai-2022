...
<meta name="url" content="https://tp-s6-web-2022-1182.herokuapp.com/accident/incendies-en-australie-accident-rechauffement-climatique_35.html">
	<meta name="copyright" content="durandal">
	<meta name="robots" content="index,follow">


		<title>
				incendies-australie-accident-rechauffement-climatique-actu
		</title>
	...
	<body
		...
		<div class="background-wallpaper-container">
			<img src="/imgs/recyclage-rechauffement-climatique.png" alt="" class="background-wallpaper" style='height:100%;'/>
					...
					<div class="col-md-9">
						<div class="col-md-12 page-body">
							<div class="row">
								...
								<div class="sub-title">
									<h2 class="green-text">
											De nombreux incendies en australie
									</h2>
									<i class="icon-bubbles" class="green-text"></i>
								</div>

								<div
									class="col-md-12 content-page" style="padding-left:20px;padding-right:20px;">
	...
	.image-gallery div:nth-child(1){
		background-image: url("/imgs/catastrophes-rechauffement-climatique.png");
	...
	<div
		class="col-md-12 blog-post" style='display:block'>

		<!-- Post Headline Start -->
		<div class="post-title">
			<h1>De nombreux incendies en australie</h1>
		</div>
		<!-- Post Headline End -->
		...
		<div class="post-info">
			<span>Article du
				Dec 15, 1998, 6:33:07 AM
				écrit par
				Thierry Regnier-Rodrigues</span>
		</div>
		<!-- Post Detail End -->
...
Il s’agit d’un phénomène naturel extrême, amplifié par les conditions météorologiques, ainsi que par d’autres causes que nous allons examiner.
		...
		<img src="/build2/images/ours-glacier-fonte-rechauffement-climatique.jpg" alt="ours-sur-un-glacier-en-fonte-rechauffement-climatique.jpg">

			<p>Aidez nous à sauver notre chère planète.</p>
		</div>
		<!-- Post Image End -->
		...
		<div class="gallery-container">
			<div class="image-gallery">
				<div class="image-gallery-element"></div>
				<div class="image-gallery-element"></div>
				<div class="image-gallery-element"></div>
			</div>
		</div>
...
</html></body></html><!-- All Javascript Plugins  --><script src="/build/runtime.js" defer></script><script src="/build/app.js" defer></script>
